...
vault write --format=json tls_pki/issue/lb_certificate common_name=*.hcpoc.bitrock.it | jq '.data | {issuing_ca: .issuing_ca, private_key: .private_key, certificate: .certificate}' > .lb-cert.json && \
